...
export const siteConfig = {
  ...
  about: {
    ...
    heroImage: "/about/about-hero.jpg",
    heroImageAlt: "About hero",
    heroTitle: "The Alchemist Behind It",
    ...
    skillsEyebrow: "▸ Proving gravity applies to divs too",
    skillsTitle: "Things I know that make the web cooler",
    skills: [
      "HTML",
      "CSS",
      "JavaScript",
